      ...
      <div className="processed-container  ">
        <div className="table-head flex justify-between items-center px-8 pt-7">
          ...
          <div className="flex gap-5">
            ...
            <div className="option-btn flex items-center justify-center">
              <svg
                width="34"
                height="34"
                viewBox="0 0 34 34"
        ...
        <table class="table-fixed w-full text-center processed-table">
          <thead>
            <tr>
          ...
          <tr className="text-black font-g-regular">
                ...
                <td>24 items</td>
                <td>$10</td>
                <td><button className="table-btn btn-pending font-g-regular">Pending</button> </td>
                <td> <div className="trash-circle text-center flex items-center justify-center">
                          <TrashIcon/>
                    </div></td>
              </tr>
              <tr className="text-black font-g-regular">
                ...
                <td>24 items</td>
                <td>$10</td>
                <td><button className="table-btn btn-cancel font-g-regular">Cancel</button> </td>
                <td> <div className="trash-circle text-center flex items-center justify-center">
                          <TrashIcon/>
                    </div></td>
              </tr>
            {data.map(data =>{
                ...
                <td>24 items</td>
                <td>$10</td>
                <td><button className="table-btn btn-completed font-g-regular">Completed</button> </td>
                <td> <div className="trash-circle text-center flex items-center justify-center">
                          <TrashIcon/>
                    </div></td>
              </tr>
